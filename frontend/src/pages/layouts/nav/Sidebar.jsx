...
const Sidebar = () => {
  return (
    <div className="md:w-[280px] h-auto bg-sidebar text-sidebar-foreground  flex flex-col">
      {/* Logo section */}
      <div className="flex justify-center gap-1 items-center md:w-[264px] h-[93px] bg-border  mt-[14px] ml-2 rounded-sm">
        <img
          src={AzubiLogo2}
          alt="Logo of letter Cj with blue color"
          decoding="async"
