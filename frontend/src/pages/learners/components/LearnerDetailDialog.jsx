      ...
      <DialogContent className="   sm:max-w-[425px] md:max-w-[700px] lg:max-w-[800px] p-6 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <DialogHeader className="flex flex-col items-center text-center">
          <Avatar className="h-24 w-24 mb-4">
            <AvatarImage src={learner.image} alt={fullName} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm mt-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-gray-900">{learner.phone || "N/A"}</span>
          </div>
          <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            ...
            <span
              className={`font-medium ${learner.isVerified ? "text-green-600" : "text-red-500"}`}
            >
