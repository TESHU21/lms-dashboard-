...
const DescriptionStacksSection = ({ track }) => {
  ...
  const { updateTrack, deleteTrack } = useCourse();
  ...
  return (
    ...
    <div className="p-6 border w-full  h-full  rounded-md  ">
      ...
      <div className="flex justify-start space-x-4 mt-6 ">
        {/* Back Button */}
        <button
          className="inline-flex items-center px-4 py-2 border h-12 w-[139px] border-gray-300 rounded-md shadow-sm bg-foreground  text-sm font-medium text-accent hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 cursor-pointer"
        ...
        {/* Update Button */}
        <button
          className="inline-flex items-center px-4 py-2 h-12 w-[139px] border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-sidebar focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer"
        ...
        {/* Delete Button */}
        <button
          className="inline-flex items-center px-4 py-2 h-12 w-[139px] border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 cursor-pointer"
