      ...
      <div className="w-full">
        <div className="flex  h-12   mt-[56px] md:justify-end md:mr-[240px]">
          <div className="flex p-6 gap-6 items-center md:w-[435px]">
            <p className="underline text-base leading-8 md:text-[20px] ">
              Need to create an account ?
            </p>
            <Button
              className=" flex gap-2 bg-sidebar  hover:bg-sidebar py-3 px-6 w-[125px] h-[48px] cursor-pointer text-white"
        ...
        <div className="md:mt-[216px] mt-12 px-8 md:px-0 md:ml-[244px]  md:w-[556px]">
          <h3 className="mb-[34px] font-lato  text-[20px] md:text-[40px] leading-8 text-center md:text-start md:leading-12 font-bold">
