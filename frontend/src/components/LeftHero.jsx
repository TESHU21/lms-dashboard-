    ...
    <div className="relative flex flex-col w-[574px] h-screen bg-[#01589A] overflow-visible">
      ...
      <div className="flex flex-col pt-10 pl-[75px] z-20">
        <div className="flex items-center gap-2 mb-4">
          <img src={AzubiLogo} alt="Logo" decoding="async" />
          <span className="font-lusitana font-extrabold text-white text-[37px] leading-[49px]">
            CLient
          </span>
        </div>
      ...
      <div className="absolute bottom-0 z-0">
        <img
          src={Person}
          alt="Running Learners on Scooters"
          loading="lazy"
          decoding="async"
        />
      </div>
